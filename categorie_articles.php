      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
              ...
              $articless=mysqli_query($connection, "SELECT * FROM `articles_categories` WHERE `id`=" . (int) $_GET['categorie']);
              $roww=mysqli_fetch_assoc($articless);
              echo $roww['title'];
               ...
               ?></h3>
                    <div class="block__content">
                      ...
                      <?php
                         $articles=mysqli_query($connection,"SELECT * FROM `articles` WHERE `categorie_id`=".(int) $_GET['categorie']." ORDER BY `id` DESC");
