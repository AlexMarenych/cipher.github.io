              ...
              <div class="block__content">
                ...
                <?php
                  ...
                  if($articles_exist==true)
                  {
                    ...
                    if($page>1)
                    {
                      echo '<a href="/articles.php?page='.($page-1).'"style="float: left; padding:10px;">&laquo; Прошлая страница</a>';
                    }
                    if($page<$total_pages)
                    {
                      echo '<a href="/articles.php?page='.($page+1).'" style="float: right; padding:10px;">  Следующая страница &raquo;</a>';
                    }
                    ?>
                    </div>
                    <?php
